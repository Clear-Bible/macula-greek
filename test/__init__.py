...
filtered_lowfat_directory_contents = filter(lowfat_filename_filter, lowfat_directory_contents)
__lowfat_files__ = list(map(lambda f: path_prefix + f, filtered_lowfat_directory_contents))
